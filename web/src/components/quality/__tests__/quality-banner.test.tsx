...
describe("QualityBanner", () => {
  ...
  it("renders nothing on the /settings/quality/signals route", () => {
    ...
    mockPathname = "/settings/quality/signals";
    const { container } = render(
      <NextIntlClientProvider locale="en" messages={messages}>
        <QualityBanner />
      </NextIntlClientProvider>,
  ...
  it("renders a critical alert with its metric copy and link", () => {
    ...
    expect(link).toHaveAttribute("href", "/settings/quality/signals");
  });
