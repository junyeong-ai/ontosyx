...
export default function UsageSettingsPage() {
  const t = useTranslations("settings.workspace.usage");
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-divider text-start text-xs font-medium uppercase text-foreground-muted">
                  ...
                  <th className="py-3 pe-6 text-end">
                  ...
                  <th className="py-3 pe-6 text-end">{t("column.cost")}</th>
                </tr>
              </thead>
              <tbody>
                {usage.map((u) => (
