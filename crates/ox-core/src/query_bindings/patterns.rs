//! Graph pattern + mutation resolution: nodes, relationships, paths, and
//! mutate operations all bind variables and record edge/property references.

use crate::query_ir::{GraphPattern, MutateOp, NodeRef, PathElement, PropertyFilter};
